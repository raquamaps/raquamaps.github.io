...
It's already possible to generate Aqua Maps with existing tools from aquamaps.org, but the raquamaps Rpackage offers an open source alternative to the earlier MS Access based solution, which simplifies licensing issues and creates a solution which is easier to maintain and develop further.
